            ...
            <Navbar isOpen={isOpen} expand="xl" full dark className='container gx-md-5 px-md-5'>
                ...
                <Collapse isOpen={isOpen} navbar>
                    <Nav navbar className="justify-content-start" style={{ width: "100%" }}>
                        <NavItem className='pt-1 pt-lg-0'><a href='/#tokenomics'>Tokenomics</a></NavItem>
                        <NavItem className='pt-1 pt-lg-0'><a href='/#timeline'>Roadmap</a></NavItem>
                        <NavItem className='pt-1 pt-lg-0'><a href='https://www.reddit.com/user/Wurklo/comments/ri14n4/what_is_wurklo/?utm_source=share&utm_medium=web2x&context=3' target="_blank" rel="noreferrer">Whitepaper</a></NavItem>
