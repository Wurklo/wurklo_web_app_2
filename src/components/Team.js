            ...
            <Container className="py-5 px-md-5 text-center text-md-start">
                ...
                <Row className="pt-5 px-md-5">
                    <Col md={3} className=''>
                        ...
                        <p className='text-center me-4'>Bobby Keel CEO<br/><span className='team-text'>Dev/AWS/Mobile</span></p>
                    </Col>
                    <Col md={3} className=''>
                        ...
                        <p className='text-center me-4'>Manoj Tilija COO<br/><span className='team-text'>Dev/AWS/Backend</span></p>
                    </Col>
                    <Col md={3} className=''>
                        ...
                        <p className='text-center me-4'>Nikki Rubrico CMO<br/><span className='team-text'>Social/Ads/Users</span></p>
                    </Col>
                    <Col md={3} className=''>
                ...
                <Row className="pt-md-5 px-md-5">
                    ...
                    <Col md={3} className=''>
                        ...
                        <p className='text-center me-4'>Odogwu Chibundu<br/><span className='team-text'>Discord Mod</span></p>
                    </Col>
                    <Col md={3} className=''>
                        <img src="https://firebasestorage.googleapis.com/v0/b/wurklo.appspot.com/o/wurklo-coin.png?alt=media&token=7d7b0ec0-18fb-4495-85cf-61655fa5edf4" alt="wurklo coin" id="coin-img" className="shadow team-img" />
